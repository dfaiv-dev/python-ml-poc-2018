...
training_data_dir = '/opt/project/training_data/dumps/gis_pps_corn_grps'
...
df_temp_csv_path = os.path.join(temp_dir, 'df_temp.csv')
print(f"writing temp df csv: {df_temp_csv_path}")
df.to_csv(df_temp_csv_path)
df = h2o.H2OFrame(df, column_types=col_types)
