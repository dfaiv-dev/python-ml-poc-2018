...
function dkr_build_h2o() {
    docker build -t h2o -f ./infrastructure/h2oai/Dockerfile-h2oai ./infrastructure/
}

function dkr_run_h2o() {
    _container_name="h2o"
    _dkr_container_remove_if_exists ${_container_name}

    docker container run -d --init --name ${_container_name} \
            -p 54321:54321 -p 54322:54322 h2o
}
...
#            --mount source=ml_out_001,target=/var/opt/pcsml/out \
    ...
    docker container run -d --init --name ${_container_name} \
            ...
            -p 42202:42202 -p 54321:54321 -p 54322:54322 \
            pcsml/dev
}
